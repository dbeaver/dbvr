...
public class DatabaseDDLCommand extends AbstractMetaCommand {
    ...
    public void run() throws CLIException {
        ...
        parent.executeWithMonitor("Get database DDL", monitor -> execute(monitor, objectName));
    }
    ...
    private void execute(@NotNull DBRProgressMonitor monitor, @NotNull String objectName) throws DBException {
        ...
        if (object == null || !parent.isRelevantObject(object)) {
            throw new CLIException("Database '" + objectName + "' not found", CLIConstants.EXIT_CODE_ERROR);
        }
        if (object instanceof DBPScriptObject dbpScriptObject) {
            ...
            throw new CLIException(
                "Database '" + objectName + "' does not support DDL",
